...
class UpdateChecker
    ...
    constructor() {
         ...
         */
        suspend fun fetchLatest(owner: String, repo: String): AvailableUpdate? =
            withContext(Dispatchers.IO) {
                val connection =
                    (URL("https://api.github.com/repos/$owner/$repo/releases/latest").openConnection() as HttpURLConnection)
                        .apply {
                            requestMethod = "GET"
