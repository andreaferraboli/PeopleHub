 ...
 */
class CsvBirthdaySupport @Inject constructor() {
    ...
    fun export(people: List<Person>): String {
        ...
        people.forEach { person ->
            ...
            builder
                .append(encodeField(person.firstName)).append(DELIMITER)
                .append(encodeField(person.lastName)).append(DELIMITER)
    ...
    private fun parseRow(fields: List<String>, lineNumber: Int): Result<Person> = runCatching {
        ...
        val birthday = parseDate(rawDate)
