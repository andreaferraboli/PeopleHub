 ...
 */
fun EventDto.toDomain(): PersonEvent = PersonEvent(
    id = id,
    title = title,
...
fun PersonEvent.toDto(): EventDto = EventDto(
    id = id,
    title = title,
...
fun BackupDto.toDomain(): BackupData = BackupData(
...
fun BackupData.toDto(): BackupDto = BackupDto(
    schemaVersion = schemaVersion,
