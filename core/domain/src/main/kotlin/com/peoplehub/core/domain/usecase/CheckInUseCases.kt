 ...
 */
class CheckInPersonUseCase @Inject constructor(
    ...
    suspend operator fun invoke(personId: Long, note: String? = null): Long {
        ...
        val id = checkInRepository.recordCheckIn(
 ...
 * check-in widget.
 */
class GetUrgentCheckInsUseCase @Inject constructor(
    private val peopleRepository: PeopleRepository,
    ...
    private fun CheckInStatus.urgencyRank(): Int = when (this) {
