...
class GetPinnedEventUseCase @Inject constructor(
    private val repository: EventRepository,
) {
...
class ObserveEventCategoriesUseCase @Inject constructor(
    private val repository: EventRepository,
) {
...
class AddEventUseCase @Inject constructor(
    ...
    suspend operator fun invoke(event: PersonEvent): Result<Long> = runCatching {
...
class SetEventPinnedUseCase @Inject constructor(
    private val repository: EventRepository,
) {
