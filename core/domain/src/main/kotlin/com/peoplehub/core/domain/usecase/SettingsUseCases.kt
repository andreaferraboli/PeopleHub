...
class UpdateDefaultThresholdUseCase @Inject constructor(
    private val repository: SettingsRepository,
) {
...
class UpdateBirthdayRemindersUseCase @Inject constructor(
    private val repository: SettingsRepository,
) {
...
class UpdateExactAlarmsUseCase @Inject constructor(
    private val repository: SettingsRepository,
) {
...
class UpdateDailyReminderHourUseCase @Inject constructor(
    private val repository: SettingsRepository,
) {
